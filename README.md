...
Citizen Report (Pending)
        ↓
Admin Verification (Pending → Verified/Rejected)
        ↓
Administration Assessment (Verified → Approved/Rejected)
        ↓
Resolution & Tracking (Approved → Completed/Forwarded)
```
...
**Made with ❤️ for better civic infrastructure and community engagement**
